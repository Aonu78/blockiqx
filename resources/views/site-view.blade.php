...
<head>
  ...
  <!-- Nucleo Icons -->
  <link href="https://soft-ui-dashboard-laravel.creative-tim.com/assets/css/nucleo-icons.css" rel="stylesheet" />
  <link href="https://soft-ui-dashboard-laravel.creative-tim.com/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="https://soft-ui-dashboard-laravel.creative-tim.com/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="https://soft-ui-dashboard-laravel.creative-tim.com/assets/css/soft-ui-dashboard.css?v=1.0.3" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show  bg-gray-100  ">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link active" href="https://soft-ui-dashboard-laravel.creative-tim.com/user-management">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark text-white " aria-hidden="true"></i>
            </div>
  ...
  <div class="sidenav-footer mx-3 ">
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      <div class="full-background" style="background-image: url('https://soft-ui-dashboard-laravel.creative-tim.com/assets/img/curved-images/white-curved.jpeg')"></div>
...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item text-sm text-dark active text-capitalize" aria-current="page">user management</li>
            </ol>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar"> 
            ...
            <li class="nav-item d-flex align-items-center">
                <a href="https://soft-ui-dashboard-laravel.creative-tim.com/logout" class="nav-link text-body font-weight-bold px-0">
            ...
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
                ...
                <li class="mb-2">
                    ...
                    <div class="d-flex py-1">
                        <div class="my-auto">
                        <img src="https://soft-ui-dashboard-laravel.creative-tim.com/assets/img/small-logos/logo-spotify.svg" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
...
<div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4e2f2a2327200e3d21283a3b27602d2123">[email&#160;protected]</a></p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Admin</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c9aabbaca8bda6bb89baa6afbdbca0e7aaa6a4">[email&#160;protected]</a></p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Creator</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="08656d656a6d7a487b676e7c7d61266b6765">[email&#160;protected]</a></p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Member</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4f3f2a3b2a3d3c20210f3c20293b3a26612c2022">[email&#160;protected]</a></p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Member</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9df0fceff4f8ddeef2fbe9e8f4b3fef2f0">[email&#160;protected]</a></p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Creator</p>
                                    </td>
    ...
    <div class="card shadow-lg ">
      ...
      <!--   Core JS Files   -->
  <script src="https://soft-ui-dashboard-laravel.creative-tim.com/assets/js/core/popper.min.js"></script>
  <script src="https://soft-ui-dashboard-laravel.creative-tim.com/assets/js/core/bootstrap.min.js"></script>
  <script src="https://soft-ui-dashboard-laravel.creative-tim.com/assets/js/plugins/perfect-scrollbar.min.js"></script>
  <script src="https://soft-ui-dashboard-laravel.creative-tim.com/assets/js/plugins/smooth-scrollbar.min.js"></script>
  <script src="https://soft-ui-dashboard-laravel.creative-tim.com/assets/js/plugins/fullcalendar.min.js"></script>
  <script src="https://soft-ui-dashboard-laravel.creative-tim.com/assets/js/plugins/chartjs.min.js"></script>
      <script>
  ...
  <script src="https://soft-ui-dashboard-laravel.creative-tim.com/assets/js/soft-ui-dashboard.min.js?v=1.0.3"></script>
